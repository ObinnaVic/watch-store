              ...
              <div className="bg-dark rounded text-light p-3 billing-details">
                <div className="d-flex">
                  ...
                  <span>
                    ...
                    <p className="checkout-text">
                      ...
                      would not be Shipped until the funds are cleared in our
                      account.
                    </p>
                  </span>
                </div>
                <div className="d-flex">
                  ...
                  <span>
                    ...
                    <p className="checkout-text">
                      Make payment by passing-in a valid, approved and signed
                      cheque. Your Order would be Shipped after cheque has been
                      cashed and cleared.
                    </p>
                  </span>
                </div>
                <div className="d-flex">
                  ...
                  <span>
                    ...
                    <p className="checkout-text">
                      Make doorstep payment to our delivery agents after package
            ...
            <div className="col-sm-12 col-lg-6 mt-5 mt-lg-0">
              <div>
                <form class="row g-3">
                  ...
                  <div class="col-12">
                    {name || email || address || addressTwo || city || zip ? <Link to="/orderplaced">
                      <button
                    ...
                    </Link>: <h6 className='text-danger'>Please enter your details</h6>}
